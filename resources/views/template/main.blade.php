...
<head>
    ...
    <title>@yield('title') | Ans Dev</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Ans Dev</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong> <a href="https://github.com/Ansell10/CRUD-website">Ans Dev</a>.</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
